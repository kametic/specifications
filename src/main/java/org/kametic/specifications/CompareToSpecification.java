...
public abstract class CompareToSpecification<T extends Comparable<T>> extends AbstractSpecification<T> {
    ...
    /**
     * Constructs a new {@link CompareToSpecification}.
     *
    ...
    /**
     * Verifies that a comparison satisfies all the requirements expressed in this specification.
     *
    ...
    /**
     * Retrieves the value we are comparing our candidates to.
     *
